...
public class HiViewPrinterProvider {
    private FrameLayout rootView;//悬浮tv的root

    private TextView floatingView;//悬浮tv
    private boolean isOpen;//是否展开log
    private FrameLayout logView;//包含recyclerView的FrameLayout
    ...
    private View genFloatingView() {
        ...
        floatingView = new TextView(rootView.getContext());
